...
Route::prefix('toko') -> group(function(){
    ...
    Route::get('create',
        [TokoController::class, 'create2'  ])  ->name  ('customer.create');

    Route::post('/',
    [TokoController::class, 'store2'   ])  ->name  ('customer.store');
    
    Route::get('/{customer}/edit',  
        [TokoController::class, 'edit2'    ])  ->name  ('customer.edit');
    
    Route::delete('/{customer}',
        [TokoController::class, 'destroy2' ])  ->name  ('customer.destroy');
    
    Route::put('/{customer}',       
        [TokoController::class, 'update2'  ])  ->name  ('customer.update');
    });
});          